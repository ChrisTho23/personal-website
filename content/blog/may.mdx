...
As Andrew Ng underlined at [Sequoia‘s AI Ascent](https://www.youtube.com/watch?v=sal78ACtGTc), agents are the future of AI. But what are agents and agentic wokflows? 
AI agents are defined as AI systems that can plan, make decisions, and take actions in a pre-defined environment. 
An example for an AI agent would be an AI system able to build you a power point pitch deck for your startup based 
on your description and some context files without you having to open PowerPoint, organize the content of the slide, 
and so on. Under the hood the AI system is working itself along an agentic workflow. Today, an agentic-workflow 
...
What sets Artisan apart is that they are not only providing the agents as standalone solutions but also the operating system (OS) allowing to orchestrate these agents. When you think about it that makes a lot of sense. Even human workers have to be onboarded on how the job works, get to know the company’s products and services, get access to all the tools they need, get to know the company’s values, and understand their goals and goal metrics. For AI workers setting this “context” is even more important. Today’s AI systems are still not very good at reasoning so the more context you provide, the better an AI system can fulfill its tasks like you intended it to, hence maximizing the alignment of the worker with your company. Furthermore, the Artisan platform allows you to communicate with your worker, like you would with a human employee, to get insights into what he is doing and give him instructions. All that is complemented with analytics dashboards and third-party app integrations.
...
## Tool of the month: Unriddle

In my function as a researcher, I am currently reading loads of papers day in and day out. A tool that I found very helpful 
for reading, understanding, citing, and summarizing paper content is [Unriddle](https://www.unriddle.ai/). Unriddle allows 
users to read research papers faster by supercharging their document editor with AI. Users simply select a paper of interest 
(etiher download or URL) and the three

## Paper of the month: Kolmogorov-Arnold Networks (KANs)
## Person of the month: Sam Altman → ETL
##  Quote of the month: “Stop trying to be liked by everybody, you don’t even like everybody”

---

# Deep dive: AI Interpretability - An overview
